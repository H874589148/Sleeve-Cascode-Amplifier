...
1. Update History:
           ...
           V1.9: a.Revised all model card files to version 1.9.
                 b.Included Monte Carlo statistical model for MOSFETs SPICE model by modifying í«ms018_v1p9_spe.lib'
		 c.Added Monte Carlo Statistical model in section 7.2.3 of the main document.
		 d.Included Monte Carlo model uses in the read me files í«ms018_v1p9_readme_spe.txt'

2. Files:

      ms018_v1p9_readme_spe.txt         .... This file!
      ms018_v1p9_spe.mdl                .... Model parameters file for N/PMOS and diode
      ms018_v1p9_spe.lib                .... Corner values for N/PMOS, BJT, resistors, MIM capacitors and varactor
      ms018_v1p9_res_spe.mdl            .... Model parameters file for resistors
      ms018_v1p9_res_spe.ckt            .... Resistor and varactor macro model
      ms018_v1p9_bjt_spe.mdl            .... Model parameters file BJT
      ms018_v1p9_mim_spe.mdl            .... Model parameters file for MIM capacitors
...
3. How to use SMIC SPICE models in spectre:
      ...
      Add the following statements to spectre netlist.
       ...
       a. Specify MOS, BJT, diode, resistor, MIM corner and model by the 'include' statement;
         ...
         include "/xxx/xxx/ms018_v1p9_spe.lib" section=tt
                                                       ^^ mos model corner

         include "/xxx/xxx/ms018_v1p9_spe.lib" section=bjt_tt
                                                           ^^ bjt model corner

         include "/xxx/xxx/ms018_v1p9_spe.lib" section=res_tt
                                                           ^^ resistor model corner

         include "/xxx/xxx/ms018_v1p9_spe.lib" section=mim_tt
                                                           ^^ mim model corner
         include "/xxx/xxx/ms018_v1p9_spe.lib" section=mc
                                                       ^^monte carlo statisitcal model

      b. Call resistor macro model subcircuit by the following statement;

         include "/xxx/xxx/ms018_v1p9_res_spe.ckt"
         ...
         Note: For metal resistor, don't need to use the subcircuit file 
               '/xxx/xxx/ms018_v1p9_res_spe.ckt'.
      ...
      c. Call N+poly/NW MOS varactor model by the following statement;
         ...
         include "/xxx/xxx/ms018_v1p9_spe.lib" section=var_tt
...
include "ms018_v1p9_spe.lib" section=mc
m1 (d1 g1 0 0 ) n18 w=10e-6 l=0.18e-6
